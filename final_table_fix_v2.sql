-- FINAL TABLE STRUCTURE FIX - Handle Existing Storage Policies
...
-- 9. Create storage bucket for file uploads (if not exists)
INSERT INTO storage.buckets (id, name, public) 
VALUES ('research-documents', 'research-documents', true)
ON CONFLICT (id) DO NOTHING;

-- 10. Drop existing storage policies if they exist, then recreate
